...
function formSuccess() {
  $("#contactForm")[0].reset(), submitMSG(!0, "Сообщение отправлено!");
}
function formError() {
  $("#contactForm")
    .removeClass()
...
function submitMSG(e, t) {
  if (e) var i = "h3 text-center tada animated text-success";
  else var i = "h3 text-center text-danger";
  $("#msgSubmit")
    .removeClass()
    .addClass(i)
    .text(t);
...
$("#contactForm")
  ...
  .on("submit", function(e) {
    e.isDefaultPrevented()
      ? (formError(), submitMSG(!1, "Вы правильно заполнили форму?"))
  ...
  $(document).on("ready", function() {
    ...
    new Swiper(".section-testimonials .swiper-container", {
      ...
      new Swiper(".section-interests .swiper-container", {
